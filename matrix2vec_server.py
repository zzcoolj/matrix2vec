...
# m1 = me.MatrixSmoothing(m1).log_shifted_positive(k_shift=None)
# m2 = m2.pmi_without_log()
# m2 = me.MatrixSmoothing(m2).log_shifted_positive(k_shift=None)
...
m1 = np.load('output/intermediate_data/firstOrder/firstOrder_w'+str(window_size)+'.npy')
m2 = np.load('input/encoded_edges_count_window_size_' + str(window_size) + '_undirected_matrix.npy')
m3 = np.concatenate((m1, m2), axis=1)
m4 = me.MatrixDimensionReducer.truncated_svd(m3, 300)
me.save_enhanced_matrix(m4, 'output/vectors/specific/m4_300.npy')
m4 = me.MatrixDimensionReducer.truncated_svd(m3, 500)
